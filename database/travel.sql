...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2019 at 12:53 AM
...
(18, 'pakistan', 'Pakistan Tour Group', '12.jpg', ''),
(24, 'explore pakistan', 'Destinations Travel ', 'fb-800x440.jpg', ''),
(25, 'TOP', 'Top International', 'top-international-tour-packages-with-price_1461928451m.jpg', ''),
(26, 'BestofGREECE', 'Best Of GREECE', 'Best-of-GREECE-Tour-Packages-from-Chennai.jpg', ''),
(27, 'BangkokPattaya', 'Bangkok  Pattaya', 'Bangkok-Pattaya-Package.png', ''),
(28, 'Europe tour ', 'Europe Tours', 'Europe-tour-packages-from-Pakistan-Tourism-Europe.jpg', ''),
(29, 'Dubai tour', 'Dubai Tour', 'Dubai-tour-packages-from-Islamabad-Pakistan.jpg', '');
...
(13, 15, 'bilal', 'Male', '03054738392', 'bilalinfo@gmail.com', 3, 1, 4, 'i want this tour', 'Confirm'),
(14, 13, 'Noman', 'Male', '03422233233', 'noman@gmail.com', 23, 3, 4, 'i want travel', 'Confirm');
...
(6, 'Haridwar', 2, 6, 130000, '43.jpg', '44.jpg', '45.jpg', 'Haridwar means the ''Gateway to the abode of the gods''. Legend has it, that Prince Bhagirath, through his penance, caused the river Ganges to come down to plains from the Himalayas so that his ancestors who had perished due to a curse of a sage could be revived. '),
...
(24, 'Best parks in islamabad ', 5, 25, 14000, '109.jpg', '110.jpg', '111.jpg', 'Islamabad is the city is famous for its backwater, park and scenic beauty and wildlife, wildlife in Islamabad are indeed some of the most magnificent and varied found anywhere in the world. The  natural mountain barriers of Islamabad, It is the list of some of the important wildlife national parks in Islamabad. '),
(25, 'Best parks in India', 5, 24, 200000, '113.jpg', '112.jpg', '114.jpg', 'There are over 80 national parks in India, spread all over the country. Some are larger and more accessible then others. Many people want to see the infamous tiger. The chance of spotting a tiger greatly depends on the size of the national park and the number of tigers, and is higher at some parks than others. '),
...
(28, 'Islamabad Family Tour  ', 1, 27, 24700, '1.jpg', '2.jpg', '3.jpg', 'A brilliant balance of cosy winter cottage accommodation and adventure, this holiday gives you a taste of the best wilderness activities and plenty of free time to explore too.');
...
(2, 'Family holiday in India    ', 1, '4.jpg', 'This relaxing holiday manages all of the organisational leg-work for you, so you can focus on combining family fun with exploring the phenomenal sights and sounds of India.'),
(3, 'Family  holiday in Canada', 1, '6.jpg', 'Our only big Canadian adventure holiday for families, with 10 days of wilderness wonders, camping and ranching. From Banff to bears, Whistler to white water rafting.'),
...
(25, 'National Parks in Pakistan ', 5, '104.jpg', 'national parks in pakistan is really beautiful.'),
(27, 'Family holiday in Pakistan ', 1, 'img.jpg', 'Family holiday in pakistan');
...
--
ALTER TABLE `advertisement`
MODIFY `Advid` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `package`
MODIFY `Packid` int(200) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
